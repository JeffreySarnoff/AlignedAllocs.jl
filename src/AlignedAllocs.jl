...
@inline public function memalign(::Type{T}, nitems::Integer, alignment::Integer=CACHE_LINE_SIZE) where T
...
""" memalign_clear
 ...
 @inline public function memalign_clear(::Type{T}, nitems::Integer, alignment::Integer=CACHE_LINE_SIZE) where T
